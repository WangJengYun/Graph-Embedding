...
from torchkge.evaluation import RelationPredictionEvaluator,LinkPredictionEvaluator
...
def main():
    ...
    # trainer.run()
    # torch.save(trainer.model, './model_files/model_test.pt')
    
    model = torch.load('./model_files/model_test.pt')
